...
// ANY FEST GESETZT
let myAny1; // ohne Datentypenangaben und ohne Initialisierung ist die Variable vom Typ 'any'
myAny1 = 'string';
let myNumber2 = 456;
myNumber2 = myAny1; // keine Fehlermeldung
let myNumber3 = myNumber2;
...
myNever = [][0];
let myNumber4 = myNever; // funktioniert bei Zuweisung zu anderen Datentypen
